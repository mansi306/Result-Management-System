...
class Register:
    def __init__(self, root):
        ...
        # ============================================ Bg image ============================================
        self.bg = ImageTk.PhotoImage(file=r"Images\b2.jpg")
        bg = Label(self.root, image=self.bg).place(x=250, y=0, width=1130, relheight=1)

        # ======================================== left image ========================================
        self.left = ImageTk.PhotoImage(file=r"Images\side.png")
        ...
        btn_login = Button(self.root, text="Sign In",command=self.login_wd, font=("times new roman", 20), bd=0, cursor="hand2").place(x=200, y=460, width=180)
    ...
    def register_data(self):
        if self.txt_fname.get() == "" or self.txt_contact.get() == "" or self.txt_email.get() == "" or self.cmb_quest.get() == "Select" or self.txt_answer.get() == "" or self.txt_password.get() == "" or self.txt_cpassword.get() == "":
            ...
            try:
                ...
                messagebox.showerror("Database Error", f"Error due to: {str(es)}", parent=self.root)
